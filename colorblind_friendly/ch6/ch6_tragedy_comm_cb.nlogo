...
to graze
  ...
  while [ max [forage] of cows < cow-forage-requirement and any? patches with [ pcolor = green + 1 ]] [
    ask cows with [forage < cow-forage-requirement] [
      if any? patches with [ pcolor = green + 1 ] [
...
to grass-regrowth
  ...
  ask patches with [pcolor = brown - 1 ] [
