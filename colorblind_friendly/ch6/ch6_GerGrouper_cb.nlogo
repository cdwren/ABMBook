...
to setup
  ...
  ask winter-patches  [ set countdown random grass-regrowth-time ;; initialize grass grow clocks randomly
    ifelse random-float 1 < 0.5 [ set pcolor grey + 2]
  [
    ifelse random-float 1 < 0.33 [ set pcolor green ][ set pcolor brown + 2]
  ]
  ]
...
to move_autumn
  ...
  ask turtles [
    if pcolor != green [
      ...
      set label round energy set label-color black
...
Line -14835848 false 135 150 135 225
Line -14835848 false 165 150 165 225
Line -14835848 false 150 150 150 225
Polygon -16777216 true false 120 45 45 105 45 90 120 30 120 45 120 45
Polygon -16777216 true false 30 225 30 105 45 90 45 225 30 225
Polygon -16777216 true false 270 225 270 105 255 105 255 225
Polygon -16777216 true false 180 30 270 105 255 105 180 45 180 30
Polygon -16777216 true false 180 30 135 30 135 45 180 45 180 30
Polygon -16777216 true false 105 45 105 0 120 0 120 30 105 45
Polygon -16777216 true false 150 30 135 30 135 0 150 0 150 30
