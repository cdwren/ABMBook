...
to setup
  ...
  ask patches [
    ...
    [
      ...
      if pcolor != brown + 2 and pcolor != yellow [ ; default value for other veg types
        set p_ext 0.01
        set pcolor green + 2
      ]
    ]
  ...
  [
    ...
    ; shades of orange which are between 21 and 25
    ; set color (random 5) + 20
    ; shades of violent which are between 111 and 115
    set color (random 5) + 110
    set size 2
