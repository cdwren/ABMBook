...
to setup
  ca
  crt 500 [ ; originally 1000
    set size 5
    set color (random 5 + 21)
  ]

  if walk = "IDD" [
    ask patches [
      set soil_quality 100
      ; this color setting is the color before the wave moves out
      ; set pcolor scale-color blue soil_quality 0 150
          set pcolor palette:scale-gradient palette:scheme-colors
      "Sequential" "YlGnBu" 5 soil_quality 0 100
    ]
  ]
...
to idd
  ...
  ask turtles [
    ...
    ; set pcolor scale-color green soil_quality 0 100
    set pcolor palette:scale-gradient palette:scheme-colors
      "Sequential" "YlGnBu" 5 soil_quality 100 0
  ]
end
