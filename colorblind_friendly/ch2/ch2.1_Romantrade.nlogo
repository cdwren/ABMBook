...
to populate
  ...
  ask vendors [
    ...
    hatch not-occupied-count [
      ...
      set distance-level [distance-level] of myself + 1                    ; distance-level equals distance-level of parent + 1
      set size 1
      set goods 0
...
to trade
  ...
  let next-tier-neighbors (vendors-on neighbors4) with [ distance-level = [ distance-level ] of myself + 1 ] ; establish trading partners: turtles on neighbouring patches with a higher distance-level
